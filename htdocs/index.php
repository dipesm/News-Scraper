...
<div class="page-header">
    ...
    <div class="header-actions">
        ...
        <a href="index.php" class="btn-sm-action" style="border-color:var(--border);color:var(--text-muted);font-size:12px">↺</a>
    </div>
</div>
...
<div class="empty-state">
    ...
    <small>Try adjusting your filters or <a href="index.php">reset</a>.</small>
</div>
<?php endif; ?>
</div>
...
document.addEventListener('DOMContentLoaded',function(){
    ...
    document.querySelectorAll('.news-modal-link').forEach(el=>{
        el.addEventListener('click',function(e){
            ...
            bsModal.show();
            fetch('index.php?get_article='+encodeURIComponent(id))
    ...
    function markRead(id){
        ...
        upd(-1);
        fetch('index.php',{method:'POST',headers:{'Content-Type':'application/x-www-form-urlencoded'},body:`action=mark_read&id=${id}`});
    }
    function markUnread(id){
        ...
        upd(+1);
        fetch('index.php',{method:'POST',headers:{'Content-Type':'application/x-www-form-urlencoded'},body:`action=mark_unread&id=${id}`});
    }
    ...
    document.getElementById('btnMarkAllRead')?.addEventListener('click',function(){
        ...
        fetch('index.php',{method:'POST',headers:{'Content-Type':'application/x-www-form-urlencoded'},body:`action=mark_all_read&date=${encodeURIComponent(date)}`})
    ...
    document.addEventListener('click',function(e){
        ...
        fetch('index.php',{method:'POST',headers:{'Content-Type':'application/x-www-form-urlencoded'},body:`action=deactivate_site&site_name=${encodeURIComponent(src)}`})
        .then(r=>r.json()).then(()=>{
